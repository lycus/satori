...
{
    public sealed class LoadPostModifyImmediateInstruction : Instruction
    {
        ...
        public LoadPostModifyImmediateInstruction(bool is16Bit)
            : this(0, is16Bit)
        {
        }

        [CLSCompliant(false)]
        public LoadPostModifyImmediateInstruction(uint value, bool is16Bit)
            : base(value, is16Bit)
        {
        }
        ...
        public override Operation Execute(Core core)
        {
            ...
            core.Registers[SourceRegister] = (int)(Subtract ? addr - imm : addr + imm);
